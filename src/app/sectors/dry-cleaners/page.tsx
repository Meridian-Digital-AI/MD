...
const sector = sectors.find((s) => s.slug === 'dry-cleaners') as Sector;
...
const iconMap: Record<string, typeof PackageSearch> = {
  PackageSearch,
  Truck,
  CalendarCheck,
  Bell,
...
export default function DryCleanersPage() {
  return (
    <>
      <script
      ...
      {/* ── WHAT WE BUILD ── */}
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-12 mb-14">
              ...
              <div
                className="relative mx-auto max-w-4xl overflow-x-auto"
                role="img"
                aria-label={`Order lifecycle: ${orderLifecycleSteps.join(' then ')}`}
              >
                <div className="flex items-start justify-between min-w-[600px] px-4">
                  ...
                  {orderLifecycleSteps.map((step, index) => (
                    ...
                    >
                      ...
                      <p className="text-small mt-3 font-semibold text-gray-900 leading-tight">
                        {step}
                      </p>
                    </div>
                  ))}
