...
const sector = sectors.find((s) => s.slug === 'salons') as Sector;
      ...
      {/* ── WHAT WE BUILD ── */}
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-12 mb-14">
              ...
              <div
                className="relative flex items-center justify-between mx-auto max-w-md"
                role="img"
                aria-label="3-tap booking flow: Service, Stylist, Time slot"
              >
                <div
                  className="absolute top-5 left-12 right-12 h-0.5 bg-blue-200"
                  aria-hidden="true"
                />
                {['Service', 'Stylist', 'Time Slot'].map((step, index) => (
                  <div
                    key={step}
      ...
      {/* ── PROOF / PROJECTION ── */}
          ...
          <div className="mx-auto max-w-3xl">
            <div className="rounded-2xl bg-navy-900 p-8 text-center lg:p-12">
              ...
              <p className="text-body mt-4 text-amber-400 font-semibold">
                The average no-show costs a salon &pound;40&ndash;&pound;80 per
                empty chair.
              </p>
            </div>
          </div>
