...
const sector = sectors.find((s) => s.slug === 'garages') as Sector;
...
const reminderStages = [
  { label: '6 weeks before', sublabel: 'First reminder' },
  { label: '2 weeks before', sublabel: 'Follow-up' },
  { label: '3 days before', sublabel: 'Final nudge' },
];
    ...
    <>
      ...
      {/* ── WHAT WE BUILD ── */}
          ...
          <div className="mx-auto max-w-5xl">
            ...
            {/* MOT Reminder Timeline */}
            <div className="mt-12 mb-14">
              <p className="text-center text-h3 font-sora text-gray-900 mb-8">
                3-Stage MOT Reminder Sequence
              </p>
              <div
                className="relative flex items-center justify-between mx-auto max-w-xl"
                role="img"
                aria-label="MOT reminder timeline: 6 weeks before, 2 weeks before, 3 days before expiry"
              >
                {/* Connecting line */}
                <div
                  className="absolute top-5 left-8 right-8 h-0.5 bg-blue-200"
                  aria-hidden="true"
                />

                {reminderStages.map((stage, index) => (
                  <div
                    key={stage.label}
                  ...
                  >
                    ...
                    <p className="text-small text-gray-500">{stage.sublabel}</p>
                  </div>
                ))}
              </div>
            </div>
